...
export default function Dashboard({ data, onReset }) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 p-6 flex flex-col gap-5
                    max-w-4xl mx-auto">
      ...
      {/* Summary cards — staggered fade up */}
